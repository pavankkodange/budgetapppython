                    ...
                    <CardContent className="space-y-3">
                      ...
                      {property.rentalIncome > 0 && (
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium">{selectedCurrency.symbol}{property.rentalIncome.toLocaleString()}</span>
                        </div>
                      )}
                      <div className="flex justify-between">
                  ...
                  <Card key={goal.id}>
                    ...
                    <CardContent className="space-y-3">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">{selectedCurrency.symbol}{goal.monthlyContribution.toLocaleString()}</span>
                      </div>
                      <div className="flex justify-between">
